       ...
       <div className='w-full h-[550px] hidden md:block'>
        ...
        <div className='p-4 flex flex-col justify-around'>
            <form>
                ...
                <div>
                    <input className='border p-2 mr-2 md:mb-4 md:w-full' type='text' placeholder='Username'/>
                    <input className='border p-2 md:w-full' type='password' placeholder='Password'/>
                </div>
